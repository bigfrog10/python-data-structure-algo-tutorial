...
def addBinary(self, a, b) -> str: # LC67. Add Binary
    x, y = int(a, 2), int(b, 2)
    while y:
        answer = x ^ y
        carry = (x & y) << 1
        x, y = answer, carry
    return bin(x)[2:]
def divide(self, A, B): # LC29. Divide Two Integers
    if A == -2147483648 and B == -1: return 2147483647  # overflow
...
def multiply(self, num1, num2): # LC43. Multiply Strings

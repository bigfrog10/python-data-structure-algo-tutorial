...
# LC389. Find the Difference    string add random char string diff one more letter random shuffle
...
# LC767. Reorganize String - rearrange chars  reorg string reorg chars any two adjacent char
...
# LC161. One Edit Distance, return true if so   operation permitted  min operations
